package de.uscoutz.nexus.schematic.laser;
...
public abstract class Laser {
    ...
    protected NexusSchematicPlugin plugin;
     ...
     */
    public void start(NexusSchematicPlugin plugin) {
    ...
    public static class GuardianLaser extends Laser {
         ...
         * @see Laser#start(NexusSchematicPlugin) to start the laser
         */
