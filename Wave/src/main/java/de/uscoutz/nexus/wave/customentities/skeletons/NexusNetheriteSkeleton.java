...
public class NexusNetheriteSkeleton extends Skeleton implements NexusMob {

    private NexusWavePlugin plugin;
    private double damage;
    private MoveToNexusGoal moveToNexusGoal;

    public NexusNetheriteSkeleton(Location loc, NexusWavePlugin plugin, double damage) {
