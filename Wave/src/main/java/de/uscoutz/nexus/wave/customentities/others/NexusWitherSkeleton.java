...
public class NexusWitherSkeleton extends WitherSkeleton implements NexusMob {

    private NexusWavePlugin plugin;
    private double damage;
    private MoveToNexusGoal moveToNexusGoal;

    public NexusWitherSkeleton(Location loc, NexusWavePlugin plugin, double damage) {
